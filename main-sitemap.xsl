			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Crisis Resolutions</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Crisis Resolutions</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>KML File</h1>
															...
															<p>
									This KML File is generated by <a href="https://rankmath.com/" >Rank Math WordPress SEO Plugin</a>. It is used to provide location information to Google.								</p>
							
							<p>
								Learn more about <a href="https://developers.google.com/kml/documentation/" >KML File</a>.							</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>XML Sitemap</h1>
															...
															<p>
									This XML Sitemap is generated by <a href="https://rankmath.com/" >Rank Math WordPress SEO Plugin</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.								</p>
							
							<p>
								Learn more about <a href="http://sitemaps.org/" >XML Sitemaps</a>.							</p>
